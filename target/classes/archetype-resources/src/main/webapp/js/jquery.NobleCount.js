...
(function(JQuery) {
	...
	**********************************************************************************/
	...
	JQuery.fn.NobleCount = function(c_obj, options) {
		var c_settings;
		var mc_passed = false;
		...
		if (typeof c_obj == 'string') {
			...
			c_settings = JQuery.extend({}, JQuery.fn.NobleCount.settings, options);
			...
			return this.each(function(){
				...
				attach_nobility(JQuerythis, c_obj, c_settings, mc_passed);
			});
		}
	...
	**********************************************************************************/
	...
	function attach_nobility(t_obj, c_obj, c_settings, mc_passed){
		...
		JQuery(t_obj).keydown(function(e) {
	...
	**********************************************************************************/
	...
	function find_remaining(t_obj, max_char){
		return max_char - (JQuery(t_obj).val()).length;
	}
